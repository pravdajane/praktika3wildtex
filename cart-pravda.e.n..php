...
<body>
    <div class="navigation">
        ...
        <a href="index.html"><img alt="картинка" class="logo" src="WildTex.png"></a>
        ...
        <div class="navigation-bottom">
            ...
            <div class="icon">
            <a href="cart.html"><img alt="картинка"  src="Контур4.png"></a>
            <a href=""><img alt="картинка" src="Сгруппировать5.png"></a>
            </div>
        </div>
    </div>
    <div class="slider">
        <a href=""><img alt="картинка" src="Сгруппировать94.png"></a>
    </div>
    ...
    <div class="summa">Ваша сумма: цена</div>
    <a href="#" class="cart-button">Оформить</a>
